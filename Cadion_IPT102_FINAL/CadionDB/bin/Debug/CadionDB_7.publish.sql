...
GO
PRINT N'Creating Table [dbo].[Juice]...';
...
GO
PRINT N'Creating Procedure [dbo].[Juice_ADD]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Juice_DEL]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Juice_DIS]...';


GO
CREATE PROCEDURE [dbo].[Juice_DIS]
			AS
BEGIN
SELECT
[Id] as Id,
...
END
GO
PRINT N'Creating Procedure [dbo].[Juice_SEA]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Juice_UPD]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'eefb8008-752a-4be9-a2d5-e668a9152478')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('eefb8008-752a-4be9-a2d5-e668a9152478')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '11dea68c-4a0a-4e3f-aeea-acf49626c401')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('11dea68c-4a0a-4e3f-aeea-acf49626c401')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '59539c95-8a53-4a7c-a988-56e72cc0f5cb')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('59539c95-8a53-4a7c-a988-56e72cc0f5cb')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'fb65001d-aa91-455a-ae16-f84dab80304e')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('fb65001d-aa91-455a-ae16-f84dab80304e')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'fd643b01-3fca-45f4-a5f5-f689deb4abb8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('fd643b01-3fca-45f4-a5f5-f689deb4abb8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'f687d6b6-ce00-4202-911c-eb17bde6444f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('f687d6b6-ce00-4202-911c-eb17bde6444f')
